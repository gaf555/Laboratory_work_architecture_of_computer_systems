...
3. [Вперёд (Отладка кода)](https://github.com/konsilerinos/ACS-labs/blob/main/Lab_2/Lab_2.md)
...
| Размер в байтах | Microsoft 32 | Microsoft 64 | GCC(MinGW) 64 |  GCC(MinGW) 32 | GCC 64 | 
| --------------- | ------------ | ------------ | ------------- | -------------- | ------ |
| char            | 1            | 1            | 1             | 1              | 1      |
...
| double          | 8            | 8            | 8             | 8              | 8      |
| double*         | 4            | 8            | 8             | 8              | 8      |
| long double     | 8            | 8            | 16            | 16             | 16     |
| long double*    | 4            | 8            |  8            | 8              | 8      |
